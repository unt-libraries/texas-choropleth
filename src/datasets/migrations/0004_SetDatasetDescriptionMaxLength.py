...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'datasets_dataset', 'description', self.gf('django.db.models.fields.TextField')(max_length=160))

    def backwards(self, orm):

        # Changing field 'Dataset.description'
        db.alter_column(u'datasets_dataset', 'description', self.gf('django.db.models.fields.TextField')())
