...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'datasets_license', (
        ...
        db.send_create_signal(u'datasets', ['License'])


        # Renaming column for 'Dataset.license' to match new field type.
        db.rename_column(u'datasets_dataset', 'license', 'license_id')
        # Changing field 'Dataset.license'
        db.alter_column(u'datasets_dataset', 'license_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['datasets.License']))
        # Adding index on 'Dataset', fields ['license']
        db.create_index(u'datasets_dataset', ['license_id'])


    def backwards(self, orm):
        # Removing index on 'Dataset', fields ['license']
        db.delete_index(u'datasets_dataset', ['license_id'])

        # Deleting model 'License'
        db.delete_table(u'datasets_license')


        # Renaming column for 'Dataset.license' to match new field type.
        db.rename_column(u'datasets_dataset', 'license_id', 'license')
        # Changing field 'Dataset.license'
        db.alter_column(u'datasets_dataset', 'license', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))
