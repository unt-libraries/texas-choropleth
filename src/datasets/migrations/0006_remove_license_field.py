...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'datasets_dataset', 'license_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'datasets_dataset', 'license',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, on_delete=models.PROTECT, to=orm['datasets.License']),
                      keep_default=False)
    ...
    models = {
        ...
        u'datasets.dataset': {
            ...
            'published': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
