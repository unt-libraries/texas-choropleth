...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Dataset.data_classes'
        db.delete_column(u'datasets_dataset', 'data_classes')

        # Deleting field 'Dataset.palette'
        db.delete_column(u'datasets_dataset', 'palette_id')

        # Deleting field 'Dataset.scale'
        db.delete_column(u'datasets_dataset', 'scale')

        # Deleting field 'Dataset.scheme'
        db.delete_column(u'datasets_dataset', 'scheme')


    def backwards(self, orm):
        # Adding field 'Dataset.data_classes'
        db.add_column(u'datasets_dataset', 'data_classes',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Dataset.palette'
        db.add_column(u'datasets_dataset', 'palette',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['colors.Palette'], null=True),
                      keep_default=False)

        # Adding field 'Dataset.scale'
        db.add_column(u'datasets_dataset', 'scale',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Dataset.scheme'
        db.add_column(u'datasets_dataset', 'scheme',
