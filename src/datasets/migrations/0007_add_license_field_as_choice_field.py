...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'datasets_dataset', 'license',
                      self.gf('django.db.models.fields.CharField')(default='CC0', max_length=48),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dataset.license'
        db.delete_column(u'datasets_dataset', 'license')
    ...
    models = {
        ...
        u'datasets.dataset': {
            ...
            'license': ('django.db.models.fields.CharField', [], {'default': "'CC0'", 'max_length': '48'}),
