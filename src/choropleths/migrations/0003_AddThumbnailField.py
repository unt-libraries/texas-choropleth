...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Choropleth.thumbnail'
        db.add_column(u'choropleths_choropleth', 'thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Choropleth.thumbnail'
        db.delete_column(u'choropleths_choropleth', 'thumbnail')
    ...
    models = {
        ...
        u'datasets.dataset': {
            ...
            'license': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True', 'blank': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '96'}),
