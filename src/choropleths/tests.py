...
class ChoroplethViewsTestCase(TestCase):
    ...
    def test_anon_user_can_view_choropleth_list(self):
        response = self.client.get(reverse('choropleths:choropleth-list'))
